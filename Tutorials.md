...
The file for this wallet is named `default.wallet` and is located in the `data-dir` directory of your EOS directory (or the directory you specified with the `--data-dir` argument when launching `keosd`)
...
Wallets first need to be opened, and because you shut down `keosd`, the wallet wasn't open. Run the following commands.
